...
class getMessenger_Bus_Default_Middleware_HandleMessageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['messenger.bus.default.middleware.handle_message'] = $instance = new \Symfony\Component\Messenger\Middleware\HandleMessageMiddleware(new \Symfony\Component\Messenger\Handler\HandlersLocator(['App\\Service\\Handler\\Guest\\Create\\CreateTechGuestMessage' => new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['.messenger.handler_descriptor.J6bZeAS'] ?? $container->load('get_Messenger_HandlerDescriptor_J6bZeASService'));
        }, 1), 'App\\Service\\Handler\\Guest\\Delete\\DeleteTechGuestMessage' => new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['.messenger.handler_descriptor.rL6y8bj'] ?? $container->load('get_Messenger_HandlerDescriptor_RL6y8bjService'));
        }, 1), 'App\\Service\\Handler\\Guest\\Update\\UpdateTechGuestMessage' => new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['.messenger.handler_descriptor.GdpQemM'] ?? $container->load('get_Messenger_HandlerDescriptor_GdpQemMService'));
